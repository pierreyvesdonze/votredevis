...
class CustomerControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'customer[companyName]' => 'Testing',
            'customer[street]' => 'Testing',
            'customer[postal]' => 'Testing',
            'customer[town]' => 'Testing',
            'customer[siret]' => 'Testing',
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'customer[postal]' => 'Something New',
            'customer[town]' => 'Something New',
            'customer[siret]' => 'Something New',
            'customer[user]' => 'Something New',
        ]);
